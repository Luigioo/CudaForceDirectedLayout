...
void CpuFr::calculateRepulsiveForces(const double* positions, double* repulsiveForces, const double k, const int numNodes) {
...
void CpuFr::calculateAttractiveForces(int* edges, int numEdges, const double* positions, double* attractiveForces,
...
void CpuFr::applyForces(double* positions, double* attractiveForces, double* repulsiveForces,
...
double* CpuFr::fruchterman_reingold_layout_cpu(int* edges, int numEdges, int numNodes,
    int iterations, double k, double temp,
    double cooling_factor, int seed) {
